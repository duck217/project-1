...
How does economic output differ across political regime types?
...
@tbl-gdp-regime shows that Territories & Colonies have the highest mean GDP per capita, followed by Royal dictatorships and Parliamentary democracies. Military and Civilian dictatorships fall at the bottom. @fig-gdp-area shows these trends over time as most regime types saw steady GDP growth from 2000 to 2020, with dips around 2015 and 2020, with Territories & Colonies claiming the biggest growth.
...
@tbl-gdp-democracy and @fig-gdp-line compare democracies and non-democracies directly. Democracies consistently have a higher mean GDP per capita across the entire period, and the gap between the two groups widens over time.
